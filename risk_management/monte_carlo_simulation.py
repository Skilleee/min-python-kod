...
def monte_carlo_simulation(initial_value, mean_return, volatility, days=252, simulations=1000):
    """
...
if __name__ == "__main__":
    expected_value = monte_carlo_simulation(initial_value=100000, mean_return=0.07, volatility=0.2)
